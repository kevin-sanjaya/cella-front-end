...
import { getInvoice, getMemberById } from '../../../redux/selectors';

class ExtendMemberInvoice extends React.Component {
    constructor(props) {
        super(props);
    ...
    fetchInvoice = () => this.props.fetchInvoice(this.props.member.memberSubscriptionTier, this.apiCallback)
    ...
    renderInvoice = () => {
        ...
        return (<Card>
            <Card.Body>
                <Card.Title>Invoice perpanjangan member</Card.Title>
                <Form style={extendMemberInvoiceStyle}>
                    <Table>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{this.props.member.memberName}</td>
                            </tr>
                        </tbody>
                    </Table>
                </Form>
                ...
                <OverlayTrigger placement="right" overlay={<Tooltip>POST request interactions have been disabled in this demo environment.</Tooltip>}>
                    <Button variant="primary" disabled={!this.state.isInvoicePaid}>Perpanjang member dan print invoice</Button>
                </OverlayTrigger>
            </Card.Body>
        </Card>);
    }
...
const extendMemberInvoiceStyle = {
    textAlign: 'left',
    marginTop: '24px'
};
...
export default connect(mapStateToProps, { fetchInvoice })(ExtendMemberInvoice);
